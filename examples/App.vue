<template>
  <div style="padding: 10px">
    ...
    <div id="area">
      <EditorWrapper ref="wrapper" autofocus :bubble-props="{ match: bubbleMatch, visible: shouldVisible, hideOnMousedown: false }" locale="zh-CN" :disabled="disabled" :dark="isDark" :style="{ width: '100%', height: '500px' }" allow-paste-html placeholder="输入正文内容..." v-model="content" @created="onCreated" :append-before-to="menus">
        <template #before>
