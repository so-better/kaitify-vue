...
## v0.0.5-beta.3 <Badge type="tip" text='2026.04.10' />

- 修复 `Wrapper` 组件在 `options.editable` 动态变更时默认值错误导致编辑器意外变为不可编辑的问题

## v0.0.5-beta.2 <Badge type="tip" text='2026.04.01' />
...
## v0.0.4-beta.26 <Badge type="tip" text='2026.03.19' />
...
## v0.0.4-beta.21 <Badge type="tip" text='2026.03.04' />

- 更新 `@kaitify/core` 的依赖版本，修复一些问题

## v0.0.4-beta.19 <Badge type="tip" text='2026.03.03' />
...
## v0.0.4-beta.16 <Badge type="tip" text='2025.10.30' />
