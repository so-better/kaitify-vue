...
- 下载地址：[kaitify-vue](https://registry.npmmirror.com/@kaitify/vue/download/@kaitify/vue-0.0.5-beta.3.tgz)
...
# 安装指定版本
yarn install @kaitify/vue@0.0.5-beta.3
```
...
# 安装指定版本
pnpm install @kaitify/vue@0.0.5-beta.3
```
