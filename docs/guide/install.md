...
- 下载地址：[kaitify-vue](https://registry.npmmirror.com/@kaitify/vue/download/@kaitify/vue-0.0.1-beta.36.tgz)
...
```html
<!-- 引入固定版本的kaitify -->
<script src="https://unpkg.com/@kaitify/vue@0.0.1-beta.36/lib/kaitify-vue.umd.js"></script>
<!-- 始终引入最新的kaitify -->
...
# 安装指定版本
npm install @kaitify/vue@0.0.1-beta.36
```
...
# 安装指定版本
yarn install @kaitify/vue@0.0.1-beta.36
```
...
# 安装指定版本
pnpm install @kaitify/vue@0.0.1-beta.36
```
